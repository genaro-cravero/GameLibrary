...
void CheckForOption(string? option)
{
    Console.WriteLine();
    switch (option)
    {
...
{
    var i = 0;
    foreach (var game in gameLibraryService.GetAllGames())
    {
...
void ShowSingleGame(Game game, string prefix = "", ConsoleColor font = ConsoleColor.White, ConsoleColor bgColor = ConsoleColor.Black)
{
...
void AddGame()
{
    ...
    gameLibraryService.AddGame(newGame);
}

Game? GetNewGameFromUser()
{
...
string? GetGameName()
{
    ...
    if (gameLibraryService.IsGameAlreadyAdded(name))
    {
...
int GetGameYear()
{
    ...
    {
        Console.WriteLine("Año inváido, intente nuevamente");
        Console.Write("Ingrese el año de lanzamiento del juego: ");
...
bool ChooseYesOrNo(string questionToRepeat = "")
{
...
List<Game> GetSearchedGame()
{
    ...
    return gameLibraryService.SearchGames(name);
}
        ...
        switch (option)
        {
            case "1":
                ...
                if (gameName != null)
                {
                    ...
                    gameLibraryService.UpdateGame(targetGame, updatedGameName);
            ...
            case "2":
                ...
                gameLibraryService.UpdateGame(targetGame, updatedGameGenre);
            ...
            case "3":
                ...
                gameLibraryService.UpdateGame(targetGame, updatedGameYear);
            ...
            case "4":
                ...
                gameLibraryService.UpdateGame(targetGame, updatedGameCompleted);
...
void DeleteGame()
{
    ...
    bool removed = gameLibraryService.DeleteGame(targetGame);
